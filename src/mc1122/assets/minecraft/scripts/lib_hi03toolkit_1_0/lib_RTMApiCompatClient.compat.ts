...
import { DisplayList, GLHelper, NGTObjectRenderer } from "jp.ngt.ngtlib.renderer";
...
import { ModelSetBase, ModelSetRail, ResourceSet } from "jp.ngt.rtm.modelpack.modelset";
...
export class RTMApiCompatClient {
    ...
    static getModelSetList<T extends ResourceSet>(modelType: string): { [name: string]: T } {
